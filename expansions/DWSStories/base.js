...
function initializeBookshelf() {
  ...
  // Build the shelf from database.js
...
function initializeStoryReader() {
  // Inject the Reader HTML structure
  const readerHTML = `
    <div id="reader-view">
  ...
  // Extract Metadata & Text from the HTML file
  ...
  // Show reader after intro animation
  setTimeout(() => {
    document.getElementById('main-header').classList.add('shrunk');
